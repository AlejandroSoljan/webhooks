...
5. Revisá y editá el resumen mediante las listas de Asisto. **Guardar borrador** conserva los cambios. **Guardar para HubSpot** usa la API del dominio cuando está disponible; mientras tanto abre o enfoca una pestaña donde ya hayas iniciado sesión en HubSpot, completa el formulario y crea el ticket desde el navegador.
