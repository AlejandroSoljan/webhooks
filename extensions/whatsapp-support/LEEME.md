...
5. Revisá y editá el resumen. **Guardar borrador** conserva los cambios. **Guardar para HubSpot** deja la tarea pendiente si el dominio todavía no tiene conexión; cuando esté disponible permite revisar la clasificación y crear el ticket. Los siguientes guardados de esa misma tarea actualizan el mismo ticket.
