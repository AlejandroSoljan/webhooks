...
const FOLLOWUP_BUILD = '2026-08-14-v4-live-classification';
...
<div class="wrap">
  ...
  <div class="filters">
    ...
    <select id="conversationState"><option value="all">Todas</option><option value="open">Abiertas</option><option value="manual">Atención manual</option><option value="closed">Finalizadas</option></select>
...
function mountConversationFollowupPanel(app, { auth } = {}) {
  ...
  app.get('/api/conversation-followup/conversations', async (req, res) => {
    try {
      ...
      if (conversationState === 'open') { q.finalized = { $ne: true }; q.manualOpen = { $ne: true }; }
      if (conversationState === 'manual') { q.finalized = { $ne: true }; q.manualOpen = true; }
