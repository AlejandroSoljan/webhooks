...
Cada modificación de una API pública debe incluir, en el mismo cambio, una nueva versión de su manual. La cabecera del manual debe registrar la versión publicada y su fecha.