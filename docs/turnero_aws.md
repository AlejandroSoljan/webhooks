...
Actualizado el 14/09/2026 a las 22:55 de Argentina. Servicio publicado en AWS; la app principal sigue en 5.00.139 con la actualización corregida del menú y notificaciones. Turnero: `/opt/asisto/turnero/releases/20260914-6`. Android: **Asisto 1.1.7**.
...
- Release AWS actual: `/opt/asisto/turnero/releases/20260914-6`, puerto 3102. App principal: `/opt/asisto/releases/5cf94e5354a5-turnero-notifications-fixed`. La release 4 corrigió el barrido para Mongo API estricta con aggregate + group; la 5 incorporó el historial automático y el filtro; la 6 integró estadísticas al shell y el selector superadmin. Ambos servicios mantienen sus releases anteriores para rollback.
