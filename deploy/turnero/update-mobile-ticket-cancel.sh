...
release_dir=/opt/asisto/turnero/releases/20260914-8
test "$previous" = /opt/asisto/turnero/releases/20260914-7
test ! -e "$release_dir"
cp -a "$previous" "$release_dir"
for file in customer_app_web.js customer_queue.js queue_pages.js queue_stats.js; do
