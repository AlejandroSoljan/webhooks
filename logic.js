...
function coalesceResponse(maybeText, pedidoObj) {
  ...
  const intentTotalOrDetalle = /\b(total|detalle|resumen|cu[aá]nto\s+es|precio|importe)\b/i.test(s);
  ...
  // Nota de milanesas: solo cuando se pide total/detalle o en resumen automático
  const shouldAppendMilaNote = hasMilanesas && (intentTotalOrDetalle || autogenerated);
