...
ROOT=Path(__file__).resolve().parents[1];SRC=ROOT/'docs/api/MANUAL_API_QR.md';OUT=ROOT/'output/pdf/Manual_API_QR_Asisto_v5.00.022.pdf';LOGO=ROOT/'static/logo-asisto-transparent.png';WIDTH=A4[0]-34*mm
