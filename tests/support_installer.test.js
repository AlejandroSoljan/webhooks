// Asisto | Version: 5.00.239 | Fecha: 2026-09-25
...
test('combined Windows installer includes Baileys and the Chrome extension without dependencies', () => {
  ...
  const archive = fs.readFileSync(path.join(root, 'static/downloads/AsistoTareas-5.00.239.zip'));
  ...
  assert.match(panel, /AsistoTareas-5\.00\.239\.zip/);
