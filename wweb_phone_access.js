...
function renderAsistoTitle() {
  return `<div class="title asisto-title"><img class="asisto-logo" src="${ASISTO_LOGO_DATA_URI}" alt="Asisto"><span>Sesión WhatsApp</span></div>`;
}
...
<head>
  ...
  <style>
    ...
    .asisto-title { display:flex; align-items:center; gap:12px; flex-wrap:wrap; }
    .asisto-logo { width:56px; height:56px; object-fit:contain; display:block; border-radius:12px; background:#12355b; padding:4px; box-shadow:0 4px 12px rgba(0,0,0,.08); }
    ...
    @media (max-width: 640px) {
      ...
      .asisto-logo { width:46px; height:46px; border-radius:10px; }
    }
...
<head>
  ...
  <style>
    ...
    .asisto-title { display:flex; align-items:center; gap:12px; flex-wrap:wrap; }
    .asisto-logo { width:52px; height:52px; object-fit:contain; display:block; border-radius:12px; background:#12355b; padding:4px; box-shadow:0 4px 12px rgba(0,0,0,.08); }
